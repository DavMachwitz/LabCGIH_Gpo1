//SkyBox								Nava Benítez David Emilio
//10/05/2026							320291599
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "SkyBox - skybox_David_Nava", nullptr, nullptr);
	...
	for (int i = 0; i < MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rightLeg = 0;
		KeyFrame[i].rightLegInc = 0;
